...
<header class="topbar">
    ...
    <div class="topbar-right">
        <form action="${pageContext.request.contextPath}/khach-hang/search" method="get">
            <div class="topbar-search" style="display: flex; align-items: center;">
                ...
                <input type="text" name="searchKeywordKh" value="${searchKeywordKh}" placeholder="Tìm kiếm khách hàng...">
            </div>
        </form>
