...
<head>
    ...
    <style>
        ...
        .info-item span { font-size: 15px; font-weight: 600; color: var(--text-dark); }
        ...
        .money-total { font-size: 22px; font-weight: 800; color: var(--pink); }
        ...
        <div class="card-body">
            <div class="info-grid">
                ...
                <div class="info-item" style="grid-column: span 2;">
                    ...
                    <span>
                        <c:forEach var="ct" items="${dsChiTiet}" varStatus="loop">
                            ${ct.giay.tenGiay} (x${ct.soLuong})
            ...
            <div class="action-bar">
                ...
                <c:if test="${hoaDon.trangThai == 'Đang giao'}">
                    <a href="${pageContext.request.contextPath}/don-hang/hoan-thanh?id=${hoaDon.id}"
                       class="btn-success">
                        ✅ Đã giao thành công
                    </a>
                </c:if>
