...
<head>
    ...
    <style>
        ...
        .collection-header h1 { text-transform: uppercase; font-weight: 800; margin-bottom: 10px; color: #222 !important; font-size: 2rem; }
                ...
                <div class="checkout-main">
                    ...
                    <div id="step-2" class="checkout-step">
                        ...
                        <div class="payment-methods">
                            <label class="payment-item" style="display:flex;align-items:center;gap:8px;margin:8px 0;cursor:pointer;">
                                <input type="radio" name="payment" value="COD" checked onclick="toggleBankInfo(false)">
                                <span style="color:#333 !important;font-size:15px;font-weight:500;">Thanh toán khi giao hàng (COD)</span>
                            </label>

                            <label class="payment-item" style="display:flex;align-items:center;gap:8px;margin:8px 0;cursor:pointer;">
                                <input type="radio" name="payment" value="Bank" onclick="toggleBankInfo(true)">
                                <span style="color:#333 !important;font-size:15px;font-weight:500;">Chuyển khoản qua ngân hàng</span>
                            </label>
                            ...
                            <div id="bank-info" class="bank-details-box" style="display: none; margin-top: 10px; padding: 10px; border: 1px dashed #ff69b4; background: #fffafb;">
                                ...
                                <p style="color:#333;">Ngân hàng: <strong style="color:#333;">Techcombank</strong></p>
                                <p style="color:#333;">STK: <strong style="color:#333;">19061706200888</strong></p>
                                <p style="color:#333;">Chủ TK: <strong style="color:#333;">DANG HUNG ANH</strong></p>
                                <p style="color:#333; font-size: 0.9em; font-style: italic;">*Nội dung: [Họ tên + SĐT đặt hàng]</p>
                            </div>
                        </div>
